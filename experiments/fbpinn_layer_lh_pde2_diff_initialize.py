...
run_name = f"FBPINN_{run_id}_diff_initialize"
...
layer_scheduler_config = {
    ...
    "left_bound_schedule": 35_000,
    "right_bound_schedule": 35_000,
    "start_left_bound": 0,
...
mlflow.end_run()
nn.save_weights(f"lh_pde_2_layer_{run_id}_diff_initialize.weights.h5")
