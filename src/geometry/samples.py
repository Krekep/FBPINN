...
def naca4_polygon(naca: str, chord: float = 1.0, n_pts: int = 600) -> list[tuple[float, float]]:
...
if __name__ == "__main__":
    ...
    plot_decomposition2d(dec.blocks, polygon_vertices=airfoil, figsize=(12, 4), savepath="decomposition_airfoil.png")
    ...
    print("Blocks per axis:", list(map(len, dec.blocks_per_axis)))
    plot_decomposition2d(dec.blocks, polygon_vertices=airfoil, figsize=(12, 4),
