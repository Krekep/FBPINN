...
run_name = f"FBPINN_layer_{run_id}_diff_initialize"
...
initializer_stddev = 1.0
mlflow.log_param("Weight initializer mean", initializer_mean)
mlflow.log_param("Weight initializer stddev", initializer_stddev)
...
nn = TensorflowFBPINN(
    **model_config,
    ...
    weight=tf.keras.initializers.RandomNormal(mean=initializer_mean, stddev=initializer_stddev),
...
layer_scheduler_config = {
    ...
    "left_bound_schedule": 120_000,
    "right_bound_schedule": 120_000,
    "start_left_bound": 0,
...
mlflow.end_run()
nn.save_weights(f"lh_pde_1_layer_{run_id}_diff_initialize.weights.h5")
