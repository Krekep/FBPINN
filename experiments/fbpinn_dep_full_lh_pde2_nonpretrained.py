...
run_name = f"FBPINN_dep_full_{run_id}_nonpretrained"
...
loss_scheduler = LossScheduler(k=0, boundary_indices=list(range(len(pde.sub_losses))))
train_config = {
    "epochs": 59_000,
    "patience": 500_000,
    "eval_interval": 400,
...
mlflow.end_run()
nn.save_weights(f"lh_pde_2_dep_full_{run_id}_non_pretrained.weights.h5")
