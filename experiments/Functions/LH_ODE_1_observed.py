...
class LH_ODE_1(PhysLoss):
    ...
    def boundary_loss_2(
        ...
        print("Boundary loss 2", u_x.shape, u_true.shape)
    ...
    def boundary_loss_3(
        ...
        """y(0) = 0, y(pi/20) = 1, y(5pi/20) = -1, y(13pi/20) = 1, y(23pi/20) = -1, y(30pi/20) = 0, y(37pi/20) = 1"""
        x = tf.constant(
            [
                [0],
                [pi / 20],
        ...
        u_true = tf.constant([[0.0], [1.0], [-1.0], [1.0], [-1.0], [0.0], [1.0]])
        print("Boundary loss 3", u_model.shape, u_true.shape)
        phys_loss = tf.reduce_mean(tf.square(u_true - u_model))
